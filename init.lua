local fastWait = loadstring(game:HttpGet("https://raw.githubusercontent.com/PysephRBX/RBXWait/master/Source.lua"))();
...
local function fastDelay(...)
    ...
    coroutine.wrap(function(...)
        local YieldTime, TimePassed = fastWait(Time);
    ...
    local _base_0 = {
      ...
      showLine = function(self, Next)
        ...
        if Next.Options.Time ~= 0 then
          fastDelay(Next.Options.Time, function()
